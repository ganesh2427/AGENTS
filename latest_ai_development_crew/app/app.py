...
# Simple interface
user_input = st.text_input("Ask about AI:", "")

if st.button("Run Agent"):
    if user_input:
        with st.spinner("Running AI Development Crew..."):
            result = run_crew_agent(user_input)
